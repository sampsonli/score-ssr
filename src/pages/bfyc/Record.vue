    ...
    <div class="v124-wrap l-flex-column l-full">
        ...
        <div class="hot-cool-wrap l-flex-1 l-relative" v-if="record">
            ...
            <div class="l-full l-scroll-y" v-if="tab === 'result' && noEmpty(record.result)">
                ...
                <div class="gl-nav" v-if="record.result.recent_record.length">近期战绩</div>
                ...
                <div class="gl-nav" v-if="record.result.history_battle.length">历史交战</div>
            ...
            <div class="l-full l-scroll-y" v-if="tab === 'asian' && noEmpty(record.asian)">
                <div class="gl-nav" v-if="record.asian.recent_record.length">近期战绩</div>
                ...
                <div class="gl-nav" v-if="record.asian.history_battle.length">历史交战</div>
            ...
            <div class="l-full l-scroll-y" v-if="tab === 'bigsmall' && noEmpty(record.bigsmall)">
                <div class="gl-nav" v-if="record.bigsmall.recent_record.length">近期战绩</div>
                ...
                <div class="gl-nav" v-if="record.bigsmall.history_battle.length">历史交战</div>
