            ...
            <div class="qi-list">
                <ul class="responsive">
                    <li class="" v-if="preAndNextExpect.pre">
                        <nuxt-link :to="{path: '/home/zq/jczq/'+ preAndNextExpect.pre}" replace>前一期</nuxt-link>
                    </li>
                    ...
                    <li class="" v-if="preAndNextExpect.next">
                        <nuxt-link :to="{path: '/home/zq/jczq/'+ preAndNextExpect.next}" replace>后一期</nuxt-link>
                    </li>
    ...
    export default {
        async asyncData ({store, params, query}) {
            ...
            if (allMatches[expect] && !query._t) {
                ...
                let { matches } = await store.dispatch('home/fetchJczqMatches', expect)
                return {
