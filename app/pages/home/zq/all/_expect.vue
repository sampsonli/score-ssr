            ...
            <div class="qi-list">
                <ul class="responsive">
                    <li class="" v-if="preAndNextExpect.pre">
                        <nuxt-link :to="{path: '/home/zq/all/'+ preAndNextExpect.pre}" replace>前一期</nuxt-link>
                    </li>
                    ...
                    <li class="" v-if="preAndNextExpect.next">
                        <nuxt-link :to="{path: '/home/zq/all/'+ preAndNextExpect.next}" replace>后一期</nuxt-link>
                    </li>
...
<script>
    ...
    export default {
        async asyncData ({store, params}) {
            let allMatches = store.state.home.zq.all.allMatches
            let {expect} = params
            expect = expect || 'cur'
