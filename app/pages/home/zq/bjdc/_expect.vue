            ...
            <div class="qi-list">
                <ul class="responsive">
                    <li class="" v-if="preAndNextExpect.pre">
                        <nuxt-link :to="{path: '/home/zq/bjdc/'+ preAndNextExpect.pre}" replace>前一期</nuxt-link>
                    </li>
                    ...
                    <li class="" v-if="preAndNextExpect.next">
                        <nuxt-link :to="{path: '/home/zq/bjdc/'+ preAndNextExpect.next}" replace>后一期</nuxt-link>
                    </li>
...
<script>
    ...
    export default {
        async asyncData ({store, params}) {
            let allMatches = store.state.home.zq.bjdc.allMatches
            let {expect} = params
            if (allMatches[expect]) {
                ...
                let { matches } = await store.dispatch('home/fetchBjdcMatches', expect)
                return {
